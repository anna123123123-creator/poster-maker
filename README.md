...
这个是做 **AI 海报设计**产品时顺手做的免费小工具——固定几套配色和排版模板，不能自由拖拽图层，也不能匹配任意素材图。完整版是 AI 智能文案排版、配色搭配、素材匹配、图层可视化编辑，源码在这：[全能源码 · AI 海报设计网站源码](https://inzyxuashop.com/aihaibao-yuanma.html)。
